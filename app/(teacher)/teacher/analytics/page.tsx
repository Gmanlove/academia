...
import type { Teacher, ClassRoom } from "@/lib/types"
...
export default function TeacherAnalyticsPage() {
  ...
  const generateStudentProgress = (): StudentProgressData[] => {
    ...
    return students.map((student) => ({
      ...
      trend: ["improving", "declining", "stable"][Math.floor(Math.random() * 3)] as
        | "improving"
        | "declining"
        | "stable",
  ...
  const filteredClasses = selectedClass === "all" ? myClasses : myClasses.filter((c) => c.id === selectedClass)

  const filteredSubjects =
    selectedSubject === "all" ? subjectAnalytics : subjectAnalytics.filter((s) => s.subject === selectedSubject)
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
            <BarChart3 className="h-8 w-8 text-primary" />📊 Class Analytics
          </h1>
          ...
          <Dialog open={reportDialogOpen} onOpenChange={setReportDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              ...
              <DialogFooter>
                ...
                <Button onClick={() => handleGenerateReport(reportType, selectedStudent)}>Generate Report</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">12% of total students</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">6% require support</p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <TableBody>
                    {classPerformance.map((performance) => (
                      <TableRow key={performance.classId}>
                        <TableCell className="font-medium">{performance.className}</TableCell>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1">
                            ...
                            <span
                              className={performance.improvement === "positive" ? "text-green-600" : "text-red-600"}
                            >
                ...
                {classPerformance.map((performance) => (
                  <div key={performance.classId} className="space-y-4 p-4 border rounded-lg">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="outline">{performance.averageScore.toFixed(1)}% avg</Badge>
                    </div>
                    ...
                    <div key={report.id} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-muted-foreground">{formatTimeAgo(report.generated)}</span>
                        </div>
                      </div>
                      <DropdownMenu>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-muted-foreground">{student.averageScore}% average</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                  ...
                  {[
                    ...
                    <div key={subject.subject} className="space-y-1">
                      <div className="flex justify-between text-sm">
                        ...
                        <span>
                          Your: {subject.yours}% | School: {subject.school}% | National: {subject.national}%
                        </span>
                      </div>
                      <div className="flex gap-1">
                        <div className="flex-1 h-2 bg-blue-200 rounded">
                          <div className="h-2 bg-blue-600 rounded" style={{ width: `${subject.yours}%` }} />
                        </div>
                        <div className="flex-1 h-2 bg-gray-200 rounded">
                          <div className="h-2 bg-gray-500 rounded" style={{ width: `${subject.school}%` }} />
                        </div>
                        <div className="flex-1 h-2 bg-gray-100 rounded">
                          <div className="h-2 bg-gray-400 rounded" style={{ width: `${subject.national}%` }} />
                        </div>
                      </div>
                    </div>
                  ))}
